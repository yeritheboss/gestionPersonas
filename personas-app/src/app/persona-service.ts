...
// esta clase la vamos a utilizar para administrar el array local, y este arreglo que es el que se usa para angular para listar personas, agregar,editar y eliminar elementos
// esto esta conectado a los servicios web por medio de la clase DataService(clase con la que conectamos los servicios web de parte de JAVA)
